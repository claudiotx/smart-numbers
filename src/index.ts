  ...
  function smartConvert(value, measurement) { // REMOVE
    ...
    let processedValue: PValue = { value: '', unitname: undefined};
    const units = ['k', 'M', 'B', 'T'];
  ...
  function roundTo(num, scale) {
    let roundNumber: any = num + "e+" + scale
  ...
  function testSmartNumbers(smartUnit) { // REMOVE
